...
function App() {
  // Clear chatbot storage completely
  useEffect(() => {
    // Clear all possible storage
    if (typeof Storage !== "undefined") {
      Object.keys(localStorage).forEach(key => {
        if (key.includes('chat') || key.includes('rcb') || key.includes('hbns')) {
  ...
  // Completely new flow structure - no automatic paths
  const flow = {
    start: {
      ...
      path: (params) => {
        // Only respond to exact option clicks
        if (params.userInput === "Services & Pricing") return "services";
        if (params.userInput === "Support & Contact") return "support";
        if (params.userInput === "Policies & Legal") return "policies";
        if (params.userInput === "Merchandise") return "merch";
        if (params.userInput === "Get a Quote") return "quote";
    ...
    services: {
      ...
      path: (params) => {
        if (params.userInput === "Pricing Details") return "pricing";
        if (params.userInput === "Digital Products") return "digital";
        if (params.userInput === "Get a Quote") return "quote";
        if (params.userInput === "Back to Main") return "start";
        return "help";
      }
    },
    ...
    pricing: {
      ...
      path: (params) => {
        if (params.userInput === "Get a Quote") return "quote";
        if (params.userInput === "Timeline Info") return "timeline";
        if (params.userInput === "Back to Main") return "start";
        return "help";
      }
    },
    ...
    timeline: {
      ...
      path: (params) => {
        if (params.userInput === "Get a Quote") return "quote";
        if (params.userInput === "Back to Pricing") return "pricing";
        if (params.userInput === "Back to Main") return "start";
        return "help";
      }
    },
    ...
    digital: {
      ...
      path: (params) => {
        if (params.userInput === "Back to Services") return "services";
        if (params.userInput === "Get a Quote") return "quote";
        if (params.userInput === "Back to Main") return "start";
        return "help";
      }
    ...
    support: {
      ...
      path: (params) => {
        if (params.userInput === "FAQ") return "faq";
        if (params.userInput === "Contact Form") return "contact";
        if (params.userInput === "Back to Main") return "start";
        return "help";
      }
    },
    ...
    faq: {
      ...
      path: (params) => {
        if (params.userInput === "Back to Support") return "support";
        if (params.userInput === "Get a Quote") return "quote";
        if (params.userInput === "Back to Main") return "start";
        return "help";
      }
    ...
    policies: {
      ...
      path: (params) => {
        if (params.userInput === "Refund Details") return "refund";
        if (params.userInput === "Privacy Info") return "privacy";
        if (params.userInput === "Back to Main") return "start";
        return "help";
      }
    },
    ...
    refund: {
      ...
      path: (params) => {
        if (params.userInput === "Back to Policies") return "policies";
        if (params.userInput === "Contact Support") return "support";
        if (params.userInput === "Back to Main") return "start";
        return "help";
      }
    },
    ...
    quote: {
      ...
      path: (params) => {
        if (params.userInput === "Back to Main") return "start";
        if (params.userInput === "Contact Support") return "support";
        if (params.userInput === "Services Info") return "services";
        return "help";
      }
    },

    help: {
      message: "I'm sorry, I didn't quite understand that. Please choose from the available options below:",
      options: ["Services & Pricing", "Support & Contact", "Policies & Legal", "Merchandise", "Get a Quote"],
      path: (params) => {
        if (params.userInput === "Services & Pricing") return "services";
        if (params.userInput === "Support & Contact") return "support";
  ...
  const settings = {
    ...
    chatHistory: {
      storageKey: null, // Disable storage completely
      maxEntries: 0,
      disabled: true
    },
    header: {
